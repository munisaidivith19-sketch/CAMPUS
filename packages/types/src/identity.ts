...
export const AuditAction = {
  ...
  // --- Academics & community (Phase 3) ---
  ATTENDANCE_MARKED: 'ATTENDANCE_MARKED',
  /** A previously marked record was changed — never a silent overwrite. */
  ...
  CLUB_MEMBERSHIP_REQUESTED: 'CLUB_MEMBERSHIP_REQUESTED',
  CLUB_MEMBERSHIP_DECIDED: 'CLUB_MEMBERSHIP_DECIDED',
